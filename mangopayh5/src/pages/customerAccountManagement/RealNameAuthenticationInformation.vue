    ...
    <div class="main_top_01">
      ...
      <el-row style="margin-bottom:20px">
        <el-col :span="24">
          ...
          <label style="padding-left: 70px" >UUID:</label>
          <el-input style="width:20%" size="mini" v-model="uuid" maxlength="64" ></el-input>
      ...
      <el-container style="padding: 10px 10px;border: 1px solid #ebebeb; border-radius: 4px;">
        ...
        <el-table ref="multipleTable" :data="tableData" border stripe tooltip-effect="dark" style="width:100%" v-loading="isLoad">
  ...
  export default {
    ...
    methods : {
      ...
      queryList () {
        ...
        this.searchParams.uuid = this.uuid;
