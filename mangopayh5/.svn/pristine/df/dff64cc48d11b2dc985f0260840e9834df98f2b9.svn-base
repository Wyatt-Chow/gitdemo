<template>
  <div class="main_top">
    <div class="main_top_01">
      <el-row style="margin-bottom:20px">
        <el-col :span="24">
          ...
          <label style="padding-left: 30px"></label>
          <el-input style="width:10%" size="mini" maxlength="20" v-model="params.mobile" placeholder="姓名/手机号"></el-input>
          <label style="padding-left: 50px"></label>
          <el-input style="width:10%" size="mini" maxlength="20" v-model="params.contract" placeholder="合同号"></el-input>
          <label style="padding-left: 50px"></label>
          <el-select v-model="params.type" placeholder="贷款类型" size="mini" style="width:20%">
            <el-option
    ...
    <el-container style="padding: 10px 10px;border: 1px solid #ebebeb; border-radius: 4px;">
      <el-header style="height: 600px;overflow:auto;"><span type="info" style="margin-left: 3%">数据列表</span>
        <el-button type="export" size="mini" @click="queryList" style="margin-left:85%" :disabled="isDisable">导出</el-button>
        <el-table ref="multipleTable" :data="tableData" stripe border style="width: 100%" v-loading="isLoad">
          <el-table-column prop="borrowingnumber" label="编号" show-overflow-tooltip width="90">
          </el-table-column>
          <el-table-column prop="name" label="姓名 " show-overflow-tooltip width="120">
          </el-table-column>
          <el-table-column prop="contractId" label="合同号" show-overflow-tooltip width="100">
          </el-table-column>
          <el-table-column prop="creatDate" label="申请日期" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="amount" label="申请额度" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="grantAmount" label="审批金额" show-overflow-tooltip>
          </el-table-column>
          ...
          <el-table-column prop="repayMode" label="贷款类型" show-overflow-tooltip>
          </el-table-column>
         <el-table-column prop=" repayType" label="还款方式" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="valueDate" label="放款时间" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="lendingChannel" label="放款通道" show-overflow-tooltip>
          </el-table-column>
           ...
           <template slot-scope="scope">
              <el-dropdown :hide-on-click="false">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item @click.native="check(scope.row)">放款登记</el-dropdown-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        typeList:[{label:'个人信用',value:'PERSON'},{label:'企业信用',value:'ENTERPRISE'}],
        params: {
          loanId:'',
          mobile:'',
          type:'',
