    ...
    <div class="main_top_01">
      <el-row style="margin-bottom:20px">
        <el-col :span="24">
          ...
          <el-button  style="margin-left:10px" size="mini" type="primary" v-if="item.resourceId == 236"  v-for="item in authButton" :key="item.resourceId" @click.stop="getExport" >导出</el-button>
  ...
  export default {
    ...
    methods:{
      ...
      getstatistics(){
        ...
        let _this =this;
        this.$http.post(_this.api.API_GATEWATE+'mango/loan/statisticsReceivable', this.params,_this.GLOBAL.topheaders())
          .then(function(res){
      ...
      getExport(){
        ...
        if(!(this.param.name||this.param.repayStartDate||this.param.repayEndDate)) {
          this.$message({
            message: "请输入搜索条件进行导出",
            type: 'info'
          });
        ...
        window.location.href=buildRequestURL(this.api.API_GATEWATE+'mango/credit/receivableContPlanDateReport',_this.param);
      ...
      init () {
        ...
        this.$http.post(_this.api.API_GATEWATE+'mango/loan/getReceivableContPlanPage', _this.params,_this.GLOBAL.topheaders())
          .then(function(res){
            this.isDisable=false;
