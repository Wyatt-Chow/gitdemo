...
function up_pic_obj3(obj,pic,F_SERVER){
	...
	if(F_SERVER==undefined || F_SERVER==''){
		if(ispic){
			...
			$('#'+obj+'_pic').html('<a href="/upfile/files?storage=1&f='+pic+'" data-lightbox="image-1" data-title="pic"><img style="float:left" height="108" width="170" src="/upfile/files?storage=1&f='+pic+'"></a>');
		}else{
			$('#'+obj+'_pic').html('<a href="/upfile/files?storage=1&f='+pic+'" style="display:block" title="'+file_ext+'" target="_blank"><img style="float:left" height="108" width="170" src="/Public/organ2/images/file.jpg"></a>')
		}
	}else{
		if(ispic){
			console.log(F_SERVER+pic);
			$('#'+obj+'_pic').html('<a href="'+F_SERVER+pic+'" data-lightbox="image-1" data-title="pic"><img style="float:left" height="108" width="170" src="'+F_SERVER+pic+'" onerror="this.src=\'/upfile/files?storage=1&f='+pic+'\'"></a>');
		}else{
			console.log(F_SERVER+pic);
	...
	$("#"+obj).siblings('span').hide().end().siblings('.closeImg').show();
	$("#"+obj).siblings('.btn').find('input' ).attr('disabled',false ).addClass('required');
}
